...
Progress: [█████░░░░░] 50% (2/6 phases complete, 13/14 plans)
...
| 03-database-integration | 4 | 15 min | 3.75 min |

**Recent Trend:**
- Last 5 plans: 03-01 (3 min), 03-02 (4 min), 03-03 (3 min), 03-04 (5 min)
...
- 03-02: XP thresholds (50/200/500/1000) for glow levels 2/3/4/5
- 03-02: Current streak must include today or yesterday to be active
- 03-02: Realtime filter by user_id for efficient per-user subscriptions
...
- 03-04: Subliminals NOT persisted locally - Supabase is source of truth
- 03-04: Evolution and streak data persisted locally for offline access
- 03-04: useMindiSync runs at app root inside AuthProvider
- 03-04: Deprecated saveSubliminal kept for offline fallback
